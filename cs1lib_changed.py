...
class CS1Canvas(QWidget):
    ...
    # changed canvas size from 400 to 800 - changed 9/18/15 by Ilona Kiss
    def __init__(self, parent = None, width = 800, height = 800, flipped_y = True):
...
def create_canvas(title = "cs1", width = 800, height = 800, flipped_y = False):
...
def start_graphics(user_fn = None, title = "cs1", width = 800, height = 800, flipped_y = False):
